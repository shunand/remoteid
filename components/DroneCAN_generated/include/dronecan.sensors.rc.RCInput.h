...
#define DRONECAN_SENSORS_RC_RCINPUT_MAX_SIZE 52
#define DRONECAN_SENSORS_RC_RCINPUT_SIGNATURE (0x51D89DF7B4971B5EULL)
#define DRONECAN_SENSORS_RC_RCINPUT_ID 1140

#define DRONECAN_SENSORS_RC_RCINPUT_STATUS_RSSI_VALID 1
