...
void MAVLinkSerial::update(void)
{
    ...
    else if (now_ms - last_hb_warn_ms >= 2000)
    {
        ...
        SYS_LOG_INF("Waiting for heartbeat\n");
    }
    update_receive();
    if (param_request_last_ms != 0 && now_ms - param_request_last_ms > 50)
    {
        ...
        {
             SYS_LOG_INF("mavlink_msg_param_value_send");
...
void MAVLinkSerial::update_send(void)
{
    ...
    {
        last_hb_ms = now_ms;
         SYS_LOG_INF("mavlink_msg_heartbeat_send");
...
void MAVLinkSerial::process_packet(mavlink_status_t &status, mavlink_message_t &msg)
{
    ...
    {
         SYS_LOG_INF("MAVLINK_MSG_ID_HEARTBEAT");
        mavlink_heartbeat_t hb;
        if (mavlink_system.sysid == 0)
        {
            SYS_LOG_INF("mavlink_msg_heartbeat_decode");
    ...
    {
        SYS_LOG_INF("mavlink_msg_open_drone_id_location_decode");
    ...
    case MAVLINK_MSG_ID_OPEN_DRONE_ID_BASIC_ID:
    {
        ...
        SYS_LOG_INF("mavlink_msg_open_drone_id_basic_id_decode");
    ...
    {
        SYS_LOG_INF("mavlink_msg_open_drone_id_authentication_decode");
        mavlink_msg_open_drone_id_authentication_decode(&msg, &authentication);
        break;
    }
    case MAVLINK_MSG_ID_OPEN_DRONE_ID_SELF_ID:
    {
         SYS_LOG_INF("mavlink_msg_open_drone_id_self_id_decode");
    ...
    {
        SYS_LOG_INF("mavlink_msg_open_drone_id_system_decode");
    ...
    {
        SYS_LOG_INF("mavlink_msg_open_drone_id_system_update_decode");
    ...
    {
         SYS_LOG_INF("mavlink_msg_open_drone_id_operator_id_decode");
    ...
    {
         SYS_LOG_INF("MAVLINK_MSG_ID_PARAM_REQUEST_LIST");
    ...
    {
          SYS_LOG_INF("  MAVLINK_MSG_ID_PARAM_REQUEST_READ");
    ...
    {
        SYS_LOG_INF("  MAVLINK_MSG_ID_PARAM_SET");
    ...
    {
          SYS_LOG_INF("  MAVLINK_MSG_ID_SECURE_COMMAND_REPLY");
...
void MAVLinkSerial::arm_status_send(void)
{
    ...
    SYS_LOG_INF("mavlink_msg_open_drone_id_arm_status_send");
